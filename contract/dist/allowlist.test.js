...
import { computeLeafCommitment, computeNullifier, bytesToHex, hexToBytes, witnesses, createShadowPassPrivateState, MIDNIGHT_CONFIG, } from './index.js';
describe('Authoritative Midnight Compact Circuit & ZK Allowlist Test Suite (Contract Workspace)', () => {
    ...
    it('Test 3: Private witnesses provider extracts witness data without mutation', () => {
        ...
        const mockContext = { privateState };
    ...
    it('Test 4: Verified Preprod configuration matches authoritative testnet endpoints', () => {
        ...
        expect(MIDNIGHT_CONFIG.defaultContractAddress).toBe('f58d3e681578fff354e5391111b384f5dca9f39c9d567bdcf9fff84727ae8f56');
    });
});
